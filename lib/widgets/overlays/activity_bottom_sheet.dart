...
class ActivityBottomSheet {
  static void show({
    ...
    required UserCreatedActivity activity,
  }) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return ActivityBottomSheetContent(
          activity: activity,
        );
      },
    );
...
class ActivityBottomSheetContent extends ConsumerStatefulWidget {
  final UserCreatedActivity activity;

  const ActivityBottomSheetContent({
    super.key, 
    required this.activity,
  });

  @override
  ConsumerState<ActivityBottomSheetContent> createState() =>
      _ActivityBottomSheetContentState();
}
...
// TODO: Put all participant attributes to participants map in UserCreatedActivity