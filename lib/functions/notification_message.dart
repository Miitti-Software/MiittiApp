...
//         switch (payload["type"]) {
//           case ("invite"):
//             debugPrint("Invite clicked ${payload["routes"]}");
//             UserCreatedActivity activity = await ref
//                 .read(firestoreServiceProvider)
//                 .getSingleActivity(payload["routes"]) as UserCreatedActivity;
//             return ActivityDetailsPage(myActivity: activity);

//           case ("request"):
//             debugPrint("Request clicked ${payload["routes"]}");
//             MiittiUser? user =
//                 await ref.read(firestoreServiceProvider).getUser(payload["routes"]);
//             if (user != null) {
...
//           case ("accept"):
//             debugPrint("Accept clicked ${payload["routes"]}");
//             UserCreatedActivity activity = await ref
//                 .read(firestoreServiceProvider)
//                 .getSingleActivity(payload["routes"]) as UserCreatedActivity;
//             return ActivityDetailsPage(myActivity: activity);
...
//           case ("message"):
//             debugPrint("Message clicked ${payload["routes"]}");
//             MiittiActivity activity = await ref
//                 .read(firestoreServiceProvider)
//                 .getSingleActivity(payload["routes"]);
