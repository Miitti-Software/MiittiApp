...
class OldPeopleScreen extends ConsumerStatefulWidget {
  const OldPeopleScreen({super.key});

  @override
  ConsumerState<OldPeopleScreen> createState() => _PeopleScreenState();
}

class _PeopleScreenState extends ConsumerState<OldPeopleScreen> {
